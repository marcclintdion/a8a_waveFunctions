    ...
    {
            basic_LIGHT_POSITION_01[0]         +=  0.5201;
    }
    ...
    {
            basic_LIGHT_POSITION_01[1]         +=  0.5201;
    } 
    ...
    {
            basic_LIGHT_POSITION_01[2]         +=  0.5201;
    }
