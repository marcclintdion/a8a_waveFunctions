...
void ProcessMouseInput(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE:
        ...
        //=====================================================================================
			...
			{
                  Pass_MIDDLE_CONTROL_Mouse += (ptMouseCurrent.y - ptMousePrev.y)   * .2;
            }                   
            //-------------------------------------------------------------------------------------
			if( middleMouseButton && keys[VK_SHIFT])
			{
                  Pass_MIDDLE_SHIFT_Mouse[0] += (ptMouseCurrent.x - ptMousePrev.x)   * .04;
                  Pass_MIDDLE_SHIFT_Mouse[1] -= (ptMouseCurrent.y - ptMousePrev.y)   * .04;
            }
            //-------------------------------------------------------------------------------------        
